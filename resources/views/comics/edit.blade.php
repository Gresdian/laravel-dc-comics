                    ...
                    <form class=" w-100 " action="{{ route('comics.update', $comic->id) }}" method="post">
                        ...
                        <div>
                            ...
                            <input class="form-control form-control-sm" type="text" name="artists" id="artistsComics"
                                required value="{{ implode(',', json_decode($comic['artists'])) }}">
                        </div>
                        ...
                        <div>
                            ...
                            <input class="form-control form-control-sm" type="text" name="writers" id="writersComics"
                                required value="{{ implode(json_decode($comic['writers'])) }}">
                        </div>
